...
# TODO: be smart here about when to activate debug symbols 
#CXXFLAGS += -g -O0 -g3 -Wno-unused-parameter -fpermissive  -fno-omit-frame-pointer 
ifeq ($(UNAME),Linux)
# TODO: be smart here about when to activate address sanitizer
...
ARFLAGS = -static -o
CXX = c++
# ce added these two lines ..
# the problem is openssl from homebrew!

#CXXFLAGS += -mmacosx-version-min=10.8 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk
#LDFLAGS += -mmacosx-version-min=10.8 -Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk
